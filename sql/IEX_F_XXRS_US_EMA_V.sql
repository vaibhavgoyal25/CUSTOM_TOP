/**********************************************************************************************************************
*                                                                                                                     *
* NAME : IEX_F_XXRS_US_EMA_V.sql                                                                                      *
*                                                                                                                     *
* DESCRIPTION : View to list US email and apps delinquent customers                                                   *
*                                                                                                                     *
...
**********************************************************************************************************************/
/* $Header: IEX_F_XXRS_US_EMA_V.sql 1.0.0 12/05/2011 15:00:00 Pavan Amirineni$ */
       ...
       AND EXISTS
             (SELECT 'X'
                FROM hz_cust_accounts hca
                   ...
                   ,  xxrs_iex_team_mapping_v tmv
               WHERE 1 = 1
                 AND hca.cust_account_id = hcsa.cust_account_id
                 AND hca.cust_account_id = de.cust_account_id
                 AND tmv.parent_flex_value = 'EMA'
