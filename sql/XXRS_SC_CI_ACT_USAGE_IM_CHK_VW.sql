/**********************************************************************************************************************
*                                                                                                                     *
* NAME : XXRS_SC_CI_ACT_USAGE_IM_CHK_VW.sql                                                                           *
*                                                                                                                     *
* DESCRIPTION : View to validate IR type usage data                                                                   *
*                                                                                                                     *
...
**********************************************************************************************************************/  
/* $Header: XXRS_SC_CI_ACT_USAGE_IM_CHK_VW.sql 1.0.0 02/25/2012 03:00:00 PM Pavan Amirineni $ */
DROP VIEW APPS.XXRS_SC_CI_ACT_USAGE_IM_CHK_VW;

/* Formatted on 3/5/2012 4:38:15 PM (QP5 v5.185.11230.41888) */
CREATE OR REPLACE FORCE VIEW apps.xxrs_sc_ci_act_usage_im_chk_vw
(
  org_id
,  cust_account_id
,  cust_acct_site_id
...
AS
  SELECT aprod.org_id
   ...
   WHERE 1 = 1
     ...
     AND NOT ( aprod.product_status_code IN
