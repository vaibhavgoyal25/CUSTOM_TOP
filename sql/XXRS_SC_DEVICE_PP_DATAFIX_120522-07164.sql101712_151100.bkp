/**************************************************************************************************************
*                                                                                                             *
* NAME : XXRS_SC_DEVICE_PP_DATAFIX_120522-07164.sql                                                           *
*                                                                                                             *
* DESCRIPTION :                                                                                               *
...
***************************************************************************************************************/
--
/* $Header: XXRS_SC_DEVICE_PP_DATAFIX_120522-07164.sql 1.0.0 07/31/2012 11:06:24 AM Vaibhav Goyal $ */
--
-- -----------------------------------------------------------------------------
--    ARGUMENTS:
--
...
SELECT 'XXRS_SC_DEVICE_PP_DATAFIX_120522-07164_'||TO_CHAR(SYSDATE,'YYYYMMDDHHMISS')||'.log' file_name
FROM DUAL
;
...
UPDATE xxrs.xxrs_sc_device_resource_tbl dev_res1
   SET dev_res1.prepay_start_date = dev_res1.billing_start_date,
       dev_res1.prepay_end_date = ADD_MONTHS (dev_res1.billing_start_date,  dev_res1.prepay_months) - 1
