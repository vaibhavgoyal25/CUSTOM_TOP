/********************************************************************************************************************
* NAME : XXRS_SC_INVOICE_WKST_INT_VW.sql                                                                            *
*                                                                                                                   *
* DESCRIPTION :                                                                                                     *
*   View developed for moving invoice workshhet interface to staging table                                          *
*                                                                                                                   *
* AUTHOR       : Kalyan                                                                                             *
...
********************************************************************************************************************/
--
/* $Header: XXRS_SC_INVOICE_WKST_INT_VW.sql 1.0.1 02-SEP-2013 10:00:00 AM Mahesh Guddeti $ */

DROP VIEW APPS.XXRS_SC_INVOICE_WKST_INT_VW;

CREATE OR REPLACE FORCE VIEW APPS.XXRS_SC_INVOICE_WKST_INT_VW
...
SELECT iw.ROWID row_id
       ...
       , iw.file_name   -- Added by Mahesh Guddeti on Sep 02 2013 --130617-06898
...
AUDIT GRANT ON APPS.XXRS_SC_INVOICE_WKST_INT_VW BY SESSION WHENEVER SUCCESSFUL;

AUDIT GRANT ON APPS.XXRS_SC_INVOICE_WKST_INT_VW BY SESSION WHENEVER NOT SUCCESSFUL;
